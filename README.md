...
$ docker-compose exec mysql mysql -u root -p -e "set global innodb_status_output = ON;"
$ docker-compose exec mysql mysql -u root -p -e "set global innodb_status_output_locks = ON;"
